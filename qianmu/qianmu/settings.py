...
DOWNLOADER_MIDDLEWARES = {
    ...
    'qianmu.middlewares.proxy.RandomProxyMiddleware':749  #必须保持其在httpproxy中间件的刚好前面
}

# 使用代理
HTTPPROXY_ENABLED = True  #设置成True就可以开始使用代理
...
ITEM_PIPELINES = {
   ...
   # 'qianmu.pipelines.RedisPipeline': 320,
   # 'qianmu.pipelines.MysqlPipeline': 340,
